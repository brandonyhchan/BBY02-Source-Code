...
function displayCards() {
    ...
    db.collection("Athletes").get()
        ...
        // all code after line 11 waits for line 7 and 11 to be completed first
        // snap refers to a single athlete document in the "Athletes" collection
        .then(snap => {
            var i = 1;
            ...
            // doc refers to the field in the "Athletes" database who is participating in the Slalom event
            snap.forEach(doc => {
